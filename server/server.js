...
const { default: serverFiles } = require('./serverFiles');

server = app.listen(process.env.PORT || 8080);
//socket.io instantiation
const io = require("socket.io")(server);
const {miArchivo,saveChat} = require('./serverFiles');

global.arrayProducts = [{ "id": 1, "title": "iPhone 11 64 GB (Product)Red", "price": 159000, "thumbnail": "https://raw.githubusercontent.com/rubeneggel72/Entrega10/main/img/img-001.jpg" },
